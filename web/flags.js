...
const FLAGS = [
    ...
    },
    {
        ...
        description: 'Mantiene la jerarquía de la tarjeta normal (escudo grande arriba, nombre debajo, marcador en el centro) pero escalada y simétrica. Nombre pegado al escudo. Estado en directo con punto rojo + minuto. Excluyente con B.',
        category: 'Backlog',
        default: true,
    ...
    },
    {
        ...
        description: 'El marcador (escudo + nombre a cada lado, resultado/hora en el centro) dentro de una píldora redondeada contenida. Nombre pegado al escudo. Estado en directo con punto rojo + minuto. Excluyente con A.',
        category: 'Backlog',
        default: false,
        requires: 'fan.hoy.backlog.compact-header',
        exclusive: 'hoy-compact-style'
